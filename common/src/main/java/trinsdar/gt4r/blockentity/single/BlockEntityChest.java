...
public class BlockEntityChest extends BlockEntityCabinet implements LidBlockEntity, Container {
    ...
    public BlockEntityChest(MaterialMachine type, BlockPos pos, BlockState state, int ySize) {
