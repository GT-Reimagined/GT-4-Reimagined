...
public class IndustrialSawmill {
    public static void init(){
        ...
        INDUSTRIAL_SAWMILLING.RB().ii(RecipeIngredient.of(GTCoreTags.RUBBER_LOGS, 1)).fi(Water.getLiquid(40)).io(new ItemStack(GTCoreItems.StickyResin), DUST.get(Wood, 1), new ItemStack(GTCoreBlocks.RUBBER_PLANKS, 6)).add("rubber_log",200, 30);
        INDUSTRIAL_SAWMILLING.RB().ii(RecipeIngredient.of(GTCoreTags.RUBBER_LOGS, 1)).fi(Lubricant.getLiquid(10)).io(new ItemStack(GTCoreItems.StickyResin), DUST.get(Wood, 1), new ItemStack(GTCoreBlocks.RUBBER_PLANKS, 6)).add("rubber_log_1",100, 30);
        INDUSTRIAL_SAWMILLING.RB().ii(RecipeIngredient.of(GTCoreTags.RUBBER_LOGS, 1)).fi(DistilledWater.getLiquid(30)).io(new ItemStack(GTCoreItems.StickyResin), DUST.get(Wood, 1), new ItemStack(GTCoreBlocks.RUBBER_PLANKS, 6)).add("rubber_log_2",200, 30);
