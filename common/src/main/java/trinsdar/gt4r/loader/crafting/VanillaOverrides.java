...
public class VanillaOverrides {
    ...
    public static void loadRecipes(Consumer<FinishedRecipe> consumer, AntimatterRecipeProvider provider){
        provider.addItemRecipe(consumer, GT4RRef.ID, "tiny_wooden_fluid_pipe", "pipes", "has_saw", provider.hasSafeItem(AntimatterDefaultTools.SAW.getTag()),
        ...
        provider.addItemRecipe(consumer, GT4RRef.ID, "small_wooden_fluid_pipe", "pipes", "has_saw", provider.hasSafeItem(AntimatterDefaultTools.SAW.getTag()),
        ...
        provider.addItemRecipe(consumer, GT4RRef.ID, "normal_wooden_fluid_pipe", "pipes", "has_saw", provider.hasSafeItem(AntimatterDefaultTools.SAW.getTag()),
        ...
        provider.addItemRecipe(consumer, GT4RRef.ID, "large_wooden_fluid_pipe", "pipes", "has_saw", provider.hasSafeItem(AntimatterDefaultTools.SAW.getTag()),
        ...
        provider.addItemRecipe(consumer, GT4RRef.ID, "chainmail_chestplate", "chainmail_armor", "has_hammer", provider.hasSafeItem(AntimatterDefaultTools.HAMMER.getTag()),
        ...
        provider.addItemRecipe(consumer, GT4RRef.ID, "chainmail_leggings", "chainmail_armor", "has_hammer", provider.hasSafeItem(AntimatterDefaultTools.HAMMER.getTag()),
        ...
        provider.addItemRecipe(consumer, GT4RRef.ID, "chainmail_boots", "chainmail_armor", "has_hammer", provider.hasSafeItem(AntimatterDefaultTools.HAMMER.getTag()),
        ...
        for (Material m : mats){
            provider.addItemRecipe(consumer, GT4RRef.ID, "piston_" + m.getId(), "pistons", "has_" + m.getId(), provider.hasSafeItem(AntimatterMaterialTypes.INGOT.getMaterialTag(m)),
