...
public class VanillaOverrides {
    ...
    public static void loadRecipes(Consumer<FinishedRecipe> consumer, AntimatterRecipeProvider provider){
        ...
        provider.addItemRecipe(consumer, Ref.ID, "chainmail_helmet", "chainmail_armor", "has_hammer", provider.hasSafeItem(AntimatterDefaultTools.HAMMER.getTag()),
                Items.CHAINMAIL_HELMET, of('R', RING.getMaterialTag(Steel), 'H', AntimatterDefaultTools.HAMMER.getTag()), "RRR", "RHR");
        provider.addItemRecipe(consumer, Ref.ID, "chainmail_chestplate", "chainmail_armor", "has_hammer", provider.hasSafeItem(AntimatterDefaultTools.HAMMER.getTag()),
                Items.CHAINMAIL_CHESTPLATE, of('R', RING.getMaterialTag(Steel), 'H', AntimatterDefaultTools.HAMMER.getTag()), "RHR", "RRR", "RRR");
        provider.addItemRecipe(consumer, Ref.ID, "chainmail_leggings", "chainmail_armor", "has_hammer", provider.hasSafeItem(AntimatterDefaultTools.HAMMER.getTag()),
                Items.CHAINMAIL_LEGGINGS, of('R', RING.getMaterialTag(Steel), 'H', AntimatterDefaultTools.HAMMER.getTag()), "RRR", "RHR", "R R");
        provider.addItemRecipe(consumer, Ref.ID, "chainmail_boots", "chainmail_armor", "has_hammer", provider.hasSafeItem(AntimatterDefaultTools.HAMMER.getTag()),
                Items.CHAINMAIL_BOOTS, of('R', RING.getMaterialTag(Steel), 'H', AntimatterDefaultTools.HAMMER.getTag()), "R R", "RHR");
        ...
        provider.shapeless(consumer, "dust_brick", "mortar_recipes", "has_mortar", provider.hasSafeItem(AntimatterDefaultTools.MORTAR.getTag()), DUST_SMALL.get(Brick, 1), AntimatterDefaultTools.MORTAR.getTag(), Items.BRICK);
        provider.shapeless(consumer, "dust_clay", "mortar_recipes", "has_mortar", provider.hasSafeItem(AntimatterDefaultTools.MORTAR.getTag()), DUST_SMALL.get(Clay, 2), AntimatterDefaultTools.MORTAR.getTag(), Items.CLAY_BALL);
