...
public class AssemblyLoader {
    public static void init() {
        ...
        ASSEMBLING.RB().ii(PLATE.getMaterialIngredient(AntimatterMaterials.Iron, 5), of(ForgeCTags.CHESTS, 1)).io(new ItemStack(Items.HOPPER, 1)).add(800, 2);
        ...
        ASSEMBLING.RB().ii(GEM.getMaterialIngredient(AntimatterMaterials.Emerald, 8), of(CIRCUITS_ADVANCED, 1)).io(new ItemStack(CircuitDataStorage, 4)).add(6400, 8);
        ...
        ASSEMBLING.RB().ii(of(Items.ENDER_PEARL, 1), DUST.getMaterialIngredient(AntimatterMaterials.Blaze, 1)).io(new ItemStack(Items.ENDER_EYE)).add(400, 2);
        ASSEMBLING.RB().ii(of(Items.ENDER_PEARL, 5), ROD.getMaterialIngredient(AntimatterMaterials.Blaze, 1)).io(new ItemStack(Items.ENDER_EYE, 5)).add(2500, 2);
        ...
        ASSEMBLING.RB().ii(DUST.getMaterialIngredient(AntimatterMaterials.Glowstone, 1), of(DUSTS_LAPIS_LAZ, 1)).io(new ItemStack(AdvCircuitParts, 2)).add(800,2);
        ASSEMBLING.RB().ii(DUST.getMaterialIngredient(AntimatterMaterials.Redstone, 4), DUST.getMaterialIngredient(AntimatterMaterials.Glowstone, 4)).io(new ItemStack(Items.REDSTONE_LAMP)).add(400, 1);
        ASSEMBLING.RB().ii(of(getTag("forge", "rods/wooden"), 1), DUST.getMaterialIngredient(AntimatterMaterials.Redstone, 1)).io(new ItemStack(Items.REDSTONE_TORCH)).add(400, 1);
        ASSEMBLING.RB().ii(INGOT.getMaterialIngredient(AntimatterMaterials.Iron, 4), DUST.getMaterialIngredient(AntimatterMaterials.Redstone, 1)).io(new ItemStack(Items.COMPASS)).add(400, 4);
        ASSEMBLING.RB().ii(INGOT.getMaterialIngredient(AntimatterMaterials.Gold, 4), DUST.getMaterialIngredient(AntimatterMaterials.Redstone, 1)).io(new ItemStack(Items.CLOCK)).add(400, 4);
        ASSEMBLING.RB().ii(of(getTag("forge", "rods/wooden"), 1), of(GTRubberData.StickyResin, 1)).io(new ItemStack(Items.TORCH, 6)).add(400, 1);
        ASSEMBLING.RB().ii(of(Items.COAL, 8), GEM.getMaterialIngredient(AntimatterMaterials.Flint, 1)).io(new ItemStack(CompressedCoalBall)).add(400, 4);
        ...
        ASSEMBLING.RB().ii(of(CompressedCoalBall, 8), of(BLOCK.getMaterialTag(AntimatterMaterials.Iron), 1)).io(new ItemStack(CoalChunk)).add(400, 4);
        ...
        ASSEMBLING.RB().ii(of(PLATE.getMaterialTag(AntimatterMaterials.Wood), 8), DUST.getMaterialIngredient(AntimatterMaterials.Redstone, 1)).io(new ItemStack(Items.NOTE_BLOCK)).add(800, 1);
        ASSEMBLING.RB().ii(of(PLATE.getMaterialTag(AntimatterMaterials.Wood), 8), GEM.getMaterialIngredient(AntimatterMaterials.Diamond, 1)).io(new ItemStack(Items.JUKEBOX)).add(1600, 1);
        ASSEMBLING.RB().ii(of(AdvancedAlloy, 2), of(ForgeCTags.GLASS, 7)).io(new ItemStack(REINFORCED_GLASS, 7)).add(400, 4);
        ASSEMBLING.RB().ii(of(getTag("minecraft", "planks"), 8), DUST.getMaterialIngredient(AntimatterMaterials.Redstone, 1)).io(new ItemStack(Items.NOTE_BLOCK)).add(800, 1);
        ASSEMBLING.RB().ii(of(getTag("minecraft", "planks"), 8), GEM.getMaterialIngredient(AntimatterMaterials.Diamond, 1)).io(new ItemStack(Items.JUKEBOX)).add(1600, 1);
        ...
        ASSEMBLING.RB().ii(PLATE.getMaterialIngredient(Invar, 2), GEM.getMaterialIngredient(AntimatterMaterials.Flint, 1)).io(new ItemStack(LighterEmpty)).add(256, 16);
