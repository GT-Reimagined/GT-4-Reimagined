...
public class FermentingLoader {
    public static void init(){
        FERMENTING.RB().fi(new FluidStack(Fluids.WATER, 1000)).ii(RecipeIngredient.of(GT4RData.Biochaff, 1)).fo(Biomass.getLiquid(1000)).add("biomass",128, 16);
        FERMENTING.RB().fi(Honey.getLiquid(1000)).ii(RecipeIngredient.of(GT4RData.Biochaff, 1)).fo(Biomass.getLiquid(1500)).add("biomass_1",128, 16);
