...
import static trinsdar.gt4r.data.RecipeMaps.COMPRESSOR;
...
public class CompressorLoader {
    public static void init() {
        ...
        COMPRESSOR.RB().ii(DUST.getMaterialIngredient(Energium, 9)).io(new ItemStack(GTCoreItems.EnergyCrystal)).add("energy_crystal",400, 2);
