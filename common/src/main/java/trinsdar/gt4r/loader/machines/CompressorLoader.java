...
public class CompressorLoader {
    public static void init() {
        ...
        COMPRESSING.RB().ii(DUST.getMaterialIngredient(AntimatterMaterials.Glowstone, 4)).io(new ItemStack(Items.GLOWSTONE)).add(400, 2);
        ...
        COMPRESSING.RB().ii(DUST.getMaterialIngredient(AntimatterMaterials.Wood, 1)).io(PLATE.get(AntimatterMaterials.Wood, 1)).add(400, 2);
        ...
        COMPRESSING.RB().ii(DUST.getMaterialIngredient(AntimatterMaterials.Quartz, 1)).io(new ItemStack(Items.QUARTZ)).add(200, 2);
