...
public class FurnaceLoader {
    public static void loadRecipes(Consumer<FinishedRecipe> output, AntimatterRecipeProvider provider){
        ...
        SimpleCookingRecipeBuilder.smelting(RecipeIngredient.of(GT4RData.CompressedFireClay, 1), GT4RData.FireBrick, 0.5F, 200).unlockedBy("has_compressed_fire_clay", provider.hasSafeItem(GT4RData.CompressedFireClay)).save(output, GT4RRef.ID + ":firebrick");
