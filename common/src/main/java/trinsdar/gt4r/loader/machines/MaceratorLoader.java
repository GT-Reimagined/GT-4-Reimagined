...
public class MaceratorLoader {
    public static void initManual(){
        ...
        UNIVERSAL_MACERATOR.RB().ii(RecipeIngredient.of(Items.TERRACOTTA, 1)).io(DUST.get(Clay, 1)).add("clay_dust_1",16, 4);
        UNIVERSAL_MACERATOR.RB().ii(RecipeIngredient.of(Items.BRICKS, 1)).io(DUST.get(Brick, 1)).add("brick_dust",100, 2);
        ...
        if (AntimatterAPI.isModLoaded(GT4RRef.MOD_CREATE)){
            UNIVERSAL_MACERATOR.RB().ii(RecipeIngredient.of(AntimatterPlatformUtils.getBlockFromId(new ResourceLocation(GT4RRef.MOD_CREATE, "limestone")), 1)).io(DUST.get(Limestone, 1)).add("limestone_dust",400, 2);
            UNIVERSAL_MACERATOR.RB().ii(RecipeIngredient.of(AntimatterPlatformUtils.getBlockFromId(new ResourceLocation(GT4RRef.MOD_CREATE, "scoria")), 1)).io(DUST.get(Scoria, 1)).add("scoria_dust",400, 2);
        }
        ...
        if (AntimatterAPI.isModLoaded("cinderscapes")){
            UNIVERSAL_MACERATOR.RB().ii(RecipeIngredient.of(AntimatterPlatformUtils.getItemFromID(new ResourceLocation("cinderscapes", "rose_quartz_ore")), 1)).io(new ItemStack(AntimatterPlatformUtils.getItemFromID(new ResourceLocation("cinderscapes", "rose_quartz")), 2)).add("rose_quartz",200, 2);
            UNIVERSAL_MACERATOR.RB().ii(RecipeIngredient.of(AntimatterPlatformUtils.getItemFromID(new ResourceLocation("cinderscapes", "smoky_quartz_ore")), 1)).io(new ItemStack(AntimatterPlatformUtils.getItemFromID(new ResourceLocation("cinderscapes", "smoky_quartz")), 2)).add("smoky_quartz",200, 2);
            UNIVERSAL_MACERATOR.RB().ii(RecipeIngredient.of(AntimatterPlatformUtils.getItemFromID(new ResourceLocation("cinderscapes", "sulfur_quartz_ore")), 1)).io(new ItemStack(AntimatterPlatformUtils.getItemFromID(new ResourceLocation("cinderscapes", "sulfur_quartz")), 2)).add("sulfur_quartz",200, 2);
        }
    }
    ...
    public static void initAuto() {
        ...
        AntimatterAPI.all(FluidPipe.class).forEach(t -> {
            ...
            if (t.getSizes().contains(PipeSize.NORMAL)) {
                UNIVERSAL_MACERATOR.RB().ii(RecipeIngredient.of(pipeNormal, 1)).io(DUST.get(t.getMaterial(), 3)).add(t.getMaterial().getId() + "_fluid_pipe_normal",t.getMaterial().getMass()*3,128);
            }
            if (t.getSizes().contains(PipeSize.LARGE)) {
                UNIVERSAL_MACERATOR.RB().ii(RecipeIngredient.of(pipeLarge, 1)).io(DUST.get(t.getMaterial(), 6)).add(t.getMaterial().getId() + "_fluid_pipe_large",t.getMaterial().getMass()*6,128);
            }
            if (t.getSizes().contains(PipeSize.HUGE)) {
                UNIVERSAL_MACERATOR.RB().ii(RecipeIngredient.of(pipeHuge, 1)).io(DUST.get(t.getMaterial(), 12)).add(t.getMaterial().getId() + "_fluid_pipe_huge",t.getMaterial().getMass()*12,128);
            }
        });
        ...
        AntimatterAPI.all(ItemPipe.class).forEach(t -> {
            ...
            if (t.getSizes().contains(PipeSize.NORMAL)) {
                UNIVERSAL_MACERATOR.RB().ii(RecipeIngredient.of(pipeNormal, 1)).io(DUST.get(t.getMaterial(), 3)).add(t.getMaterial().getId() + "_item_pipe_normal",t.getMaterial().getMass()*3,128);
            }
            if (t.getSizes().contains(PipeSize.LARGE)) {
                UNIVERSAL_MACERATOR.RB().ii(RecipeIngredient.of(pipeLarge, 1)).io(DUST.get(t.getMaterial(), 6)).add(t.getMaterial().getId() + "_item_pipe_large",t.getMaterial().getMass()*6,128);
            }
            if (t.getSizes().contains(PipeSize.HUGE)) {
                UNIVERSAL_MACERATOR.RB().ii(RecipeIngredient.of(pipeHuge, 1)).io(DUST.get(t.getMaterial(), 12)).add(t.getMaterial().getId() + "_item_pipe_huge",t.getMaterial().getMass()*12,128);
            }
        });
