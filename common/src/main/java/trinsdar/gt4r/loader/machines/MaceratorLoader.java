...
public class MaceratorLoader {
    public static void initManual(){
        ...
        MACERATING.RB().ii(RecipeIngredient.of(Items.BRICK, 1)).io(AntimatterMaterialTypes.DUST_SMALL.get(Brick, 1)).add(25, 2);
        MACERATING.RB().ii(RecipeIngredient.of(Items.CLAY_BALL, 1)).io(AntimatterMaterialTypes.DUST_SMALL.get(Clay, 2)).add(16, 4);
        ...
        MACERATING.RB().ii(RecipeIngredient.of(Items.CLAY, 1)).io(AntimatterMaterialTypes.DUST.get(Clay, 2)).add(30, 4);
        MACERATING.RB().ii(RecipeIngredient.of(Items.TERRACOTTA, 1)).io(AntimatterMaterialTypes.DUST.get(Clay, 1)).add(16, 4);
        MACERATING.RB().ii(RecipeIngredient.of(Items.BRICKS, 1)).io(AntimatterMaterialTypes.DUST.get(Brick, 1)).add(100, 2);
        MACERATING.RB().ii(RecipeIngredient.of(ItemTags.LOGS, 1)).io(AntimatterMaterialTypes.DUST.get(AntimatterMaterials.Wood, 6)).add(400, 2);
        MACERATING.RB().ii(RecipeIngredient.of(Items.PRISMARINE, 1)).io(AntimatterMaterialTypes.DUST.get(AntimatterMaterials.Prismarine, 1)).add(400, 2);
        MACERATING.RB().ii(RecipeIngredient.of(Items.DARK_PRISMARINE, 1)).io(AntimatterMaterialTypes.DUST.get(AntimatterMaterials.DarkPrismarine, 1)).add(400, 2);
        if (AntimatterAPI.isModLoaded(Ref.MOD_CREATE)){
            MACERATING.RB().ii(RecipeIngredient.of(AntimatterPlatformUtils.getBlockFromId(new ResourceLocation(Ref.MOD_CREATE, "limestone")), 1)).io(AntimatterMaterialTypes.DUST.get(Limestone, 1)).add(400, 2);
            MACERATING.RB().ii(RecipeIngredient.of(AntimatterPlatformUtils.getBlockFromId(new ResourceLocation(Ref.MOD_CREATE, "weathered_limestone")), 1)).io(AntimatterMaterialTypes.DUST.get(Limestone, 1)).add(400, 2);
            MACERATING.RB().ii(RecipeIngredient.of(AntimatterPlatformUtils.getBlockFromId(new ResourceLocation(Ref.MOD_CREATE, "scoria")), 1)).io(AntimatterMaterialTypes.DUST.get(Scoria, 1)).add(400, 2);
            MACERATING.RB().ii(RecipeIngredient.of(AntimatterPlatformUtils.getBlockFromId(new ResourceLocation(Ref.MOD_CREATE, "dark_scoria")), 1)).io(AntimatterMaterialTypes.DUST.get(Scoria, 1)).add(400, 2);
        }
    ...
    public static void initAuto() {
        ...
        AntimatterMaterialTypes.CRUSHED.all().forEach(m -> {
            ...
            if (m == AntimatterMaterials.NetheriteScrap){
                MACERATING.RB().ii(ore).io(Utils.ca((ORE_MULTI.getInt(m) * multiplier) * 2, crushedStack), AntimatterMaterialTypes.DUST.get(oreByProduct1, 1), AntimatterMaterialTypes.DUST.get(AntimatterMaterials.Netherrack, 1)).chances(1.0, 0.1 * multiplier * BY_PRODUCT_MULTI.getInt(m), 0.5).add(400, 2);
            }
            MACERATING.RB().ii(crushed).io(AntimatterMaterialTypes.DUST_IMPURE.get(MACERATE_INTO.getMapping(m), 1), AntimatterMaterialTypes.DUST.get(oreByProduct1, 1)).chances(1.0, 0.1).add(400, 2);
            MACERATING.RB().ii(RecipeIngredient.of(AntimatterMaterialTypes.CRUSHED_PURIFIED.getMaterialTag(m), 1)).io(AntimatterMaterialTypes.DUST_PURE.get(MACERATE_INTO.getMapping(m), 1), AntimatterMaterialTypes.DUST.get(oreByProduct2, 1)).chances(1.0, 0.1).add(400, 2);
            MACERATING.RB().ii(RecipeIngredient.of(AntimatterMaterialTypes.CRUSHED_CENTRIFUGED.getMaterialTag(m), 1)).io(AntimatterMaterialTypes.DUST.get(MACERATE_INTO.getMapping(m), 1), AntimatterMaterialTypes.DUST.get(oreByProduct3, 1)).chances(1.0, 0.1).add(400, 2);
            if (m.has(AntimatterMaterialTypes.RAW_ORE)){
                MACERATING.RB().ii(RecipeIngredient.of(AntimatterMaterialTypes.RAW_ORE.getMaterialTag(m), 1)).io(Utils.ca((ORE_MULTI.getInt(m) * multiplier) * 2, crushedStack), AntimatterMaterialTypes.DUST.get(oreByProduct1, 1)).chances(1.0, 0.1 * multiplier * BY_PRODUCT_MULTI.getInt(m)).add(400, 2);
            }
        });
        AntimatterMaterialTypes.DUST.all().forEach(m -> {
            if (m.has(AntimatterMaterialTypes.PLATE) && m != AntimatterMaterials.Wood){
                ...
                MACERATING.RB().ii(AntimatterMaterialTypes.PLATE.getMaterialIngredient(m, 1)).io(AntimatterMaterialTypes.DUST.get(m, 1)).add(duration, 4);
            }
            if (m.has(AntimatterMaterialTypes.INGOT)){
                long duration = m.getMass();
                MACERATING.RB().ii(AntimatterMaterialTypes.INGOT.getMaterialIngredient(m, 1)).io(AntimatterMaterialTypes.DUST.get(m, 1)).add(duration, 4);
            }
            if (m.has(AntimatterMaterialTypes.GEM)){
                long duration = m.getMass();
                MACERATING.RB().ii(AntimatterMaterialTypes.GEM.getMaterialIngredient(m, 1)).io(AntimatterMaterialTypes.DUST.get(m, 1)).add(duration, 4);
            }
        });
        AntimatterAPI.all(StoneType.class, s -> {
            if (s.getMaterial() == Material.NULL || !s.getMaterial().has(AntimatterMaterialTypes.DUST)) return;
            MACERATING.RB().ii(RecipeIngredient.of(s.getState().getBlock().asItem(), 1)).io(AntimatterMaterialTypes.DUST.get(s.getMaterial(), 1)).add(400, 2);
            if (s instanceof CobbleStoneType){
                MACERATING.RB().ii(RecipeIngredient.of(((CobbleStoneType)s).getBlock("cobble").asItem(), 1)).io(AntimatterMaterialTypes.DUST.get(s.getMaterial(), 1)).add(400, 2);
            }
        });
        AntimatterAPI.all(FluidPipe.class).forEach(t -> {
            ...
            MACERATING.RB().ii(RecipeIngredient.of(pipeTiny, 1)).io(AntimatterMaterialTypes.DUST_SMALL.get(t.getMaterial(), 2)).add(t.getMaterial().getMass()/2,128);
            MACERATING.RB().ii(RecipeIngredient.of(pipeSmall, 1)).io(AntimatterMaterialTypes.DUST.get(t.getMaterial(), 1)).add(t.getMaterial().getMass(),128);
            MACERATING.RB().ii(RecipeIngredient.of(pipeNormal, 1)).io(AntimatterMaterialTypes.DUST.get(t.getMaterial(), 3)).add(t.getMaterial().getMass()*3,128);
            MACERATING.RB().ii(RecipeIngredient.of(pipeLarge, 1)).io(AntimatterMaterialTypes.DUST.get(t.getMaterial(), 6)).add(t.getMaterial().getMass()*6,128);
            MACERATING.RB().ii(RecipeIngredient.of(pipeHuge, 1)).io(AntimatterMaterialTypes.DUST.get(t.getMaterial(), 12)).add(t.getMaterial().getMass()*12,128);
        });
