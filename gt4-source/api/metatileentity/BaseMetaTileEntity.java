	...
	public boolean onRightclick(EntityPlayer aPlayer, byte aSide, float aX, float aY, float aZ) {
		...
		if (isServerSide()) {
			...
			if (isUpgradable() && aPlayer.inventory.getCurrentItem() != null) {
				...
				if (GT_Utility.areStacksEqual(aPlayer.inventory.getCurrentItem(), GT_ModHandler.getIC2Item("overclockerUpgrade", 1))) {
				...
				if (getInputVoltage() < GregTech_API.VOLTAGE_HIGH && getOutputVoltage()*getOutputAmperage() < GregTech_API.VOLTAGE_HIGH){
					if (GT_Utility.areStacksEqual(aPlayer.inventory.getCurrentItem(), GT_ModHandler.getIC2Item("transformerUpgrade", 1))) {
				...
				if (GT_Utility.areStacksEqual(aPlayer.inventory.getCurrentItem(), GT_ModHandler.getIC2Item("energyStorageUpgrade", 1))) {
