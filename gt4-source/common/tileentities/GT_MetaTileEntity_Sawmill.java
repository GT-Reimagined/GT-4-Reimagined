...
public class GT_MetaTileEntity_Sawmill extends MetaTileEntity {
    ...
    private boolean checkRecipe() {
    	...
    	GT_Recipe tRecipe = GT_Recipe.findEqualSawmillRecipe(mInventory[0], mInventory[1]);
    	if (tRecipe != null) {
        	...
        	tRecipe = GT_Recipe.findEqualSawmillRecipe(mInventory[0], tWaterStack);
    		if (tRecipe != null && spaceForOutput(tRecipe)) {
    			if (tRecipe.isRecipeInputEqual(true, true, mInventory[0], tWaterStack)) {
		        	...
		        	mOutputItem1 = GT_Utility.copy(tRecipe.mOutput1);
		        	mOutputItem2 = GT_Utility.copy(tRecipe.mOutput2);
		        	if (!GT_Utility.areStacksEqual(tRecipe.mOutput3, GT_ModHandler.getEmptyCell(1))) mOutputItem3 = GT_Utility.copy(tRecipe.mOutput3);
		        	return true;
    			}
			}
    	}
