...
public class GT_MetaTileEntity_BronzeSteamHammer extends GT_MetaTileEntity_BasicMachine_Bronze {
	...
	public GT_MetaTileEntity_BronzeSteamHammer(int aID, String mName, String mNameRegional) {
    ...
    public void doSound(byte aIndex, double aX, double aY, double aZ) {
		...
		if (aIndex == 10) GT_Utility.doSoundAtClient(GregTech_API.sSoundList.get(1), 1.0F, 0.01F, aX, aY, aZ);
	}
