...
public class CannerLoader {
    public static void init(){
        ...
        CANNER.RB().ii(of(BatteryHull, 1), DUST.getMaterialIngredient(Lithium, 2)).io(new ItemStack(LithiumBattery)).add("lithium_battery",100, 2);
        ...
        CANNER.RB().ii(of(BatteryHull, 1), DUST.getMaterialIngredient(Redstone, 2)).io(new ItemStack(REBattery)).add("re_battery",100, 2);
