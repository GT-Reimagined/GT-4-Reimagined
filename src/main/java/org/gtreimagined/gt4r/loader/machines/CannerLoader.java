...
import static org.gtreimagined.gt4r.data.GT4RItems.SmallBatteryHull;
import static org.gtreimagined.gt4r.data.GT4RItems.REBattery;
...
public class CannerLoader {
    public static void init(){
        ...
        CANNER.RB().ii(of(SmallBatteryHull, 1), DUST.getMaterialIngredient(Redstone, 2)).io(new ItemStack(REBattery)).add("battery_re",100, 2);
