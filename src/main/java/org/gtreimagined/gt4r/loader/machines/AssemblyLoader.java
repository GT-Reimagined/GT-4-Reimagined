...
public class AssemblyLoader {
    public static void init() {
        ...
        RecipeMaps.ASSEMBLER.RB().ii(of(AdvancedCircuitBoard, 1), of(AdvancedCircuitParts, 2)).io(new ItemStack(AdvancedCircuit, 1)).add("circuit_advanced", 1600, 2);
        RecipeMaps.ASSEMBLER.RB().ii(of(ProcessorCircuitBoard, 1), of(DataStorageCircuit, 1)).io(new ItemStack(DataControlCircuit, 2)).add("circuit_data_control", 3200, 4);
        RecipeMaps.ASSEMBLER.RB().ii(of(ProcessorCircuitBoard, 1), of(LapotronCrystal, 1)).io(new ItemStack(EnergyFlowCircuit, 1)).add("circuit_energy_flow", 3200, 4);
        RecipeMaps.ASSEMBLER.RB().ii(of(DataControlCircuit, 1), of(DataStorageCircuit, 8)).io(new ItemStack(DataOrb, 1)).add("data_orb",12800, 16);
        ...
        RecipeMaps.ASSEMBLER.RB().ii(of(PLATES_IRON_ALUMINIUM, 1), PLATE.getMaterialIngredient(RedAlloy, 2)).io(new ItemStack(BasicCircuitBoard)).add("circuit_board_basic",800, 1);
        RecipeMaps.ASSEMBLER.RB().ii(of(PLATES_IRON_ALUMINIUM, 1), PLATE.getMaterialIngredient(Electrum, 2)).io(new ItemStack(BasicCircuitBoard, 2)).add("circuit_board_basic_1",800, 1);
        RecipeMaps.ASSEMBLER.RB().ii(PLATE.getMaterialIngredient(Plastic, 1), PLATE.getMaterialIngredient(RedAlloy, 2)).io(new ItemStack(BasicCircuitBoard)).add("circuit_board_basic_2",800, 1);
        RecipeMaps.ASSEMBLER.RB().ii(PLATE.getMaterialIngredient(Plastic, 1), PLATE.getMaterialIngredient(Electrum, 2)).io(new ItemStack(BasicCircuitBoard, 2)).add("circuit_board_basic_3",800, 1);
        ...
        RecipeMaps.ASSEMBLER.RB().ii(PLATE.getMaterialIngredient(Electrum, 2), of(CIRCUITS_BASIC, 1)).io(new ItemStack(AdvancedCircuitBoard)).add("circuit_board_advanced",1600,2);
        RecipeMaps.ASSEMBLER.RB().ii(PLATE.getMaterialIngredient(Electrum, 4), PLATE.getMaterialIngredient(Silicon, 1)).io(new ItemStack(AdvancedCircuitBoard, 2)).add("circuit_board_advanced_1",1600,2);
        RecipeMaps.ASSEMBLER.RB().ii(PLATE.getMaterialIngredient(Platinum, 1), of(CIRCUITS_ADVANCED, 1)).io(new ItemStack(ProcessorCircuitBoard)).add("circuit_board_processor",1600,2);
        ...
        RecipeMaps.ASSEMBLER.RB().ii(GEM.getMaterialIngredient(Emerald, 8), of(CIRCUITS_ADVANCED, 1)).io(new ItemStack(DataStorageCircuit, 4)).add("circuit_data_storage",6400, 8);
        RecipeMaps.ASSEMBLER.RB().ii(GEM.getMaterialIngredient(Olivine, 8), of(CIRCUITS_ADVANCED, 1)).io(new ItemStack(DataStorageCircuit, 4)).add("circuit_data_storage_1",6400, 8);
        ...
        RecipeMaps.ASSEMBLER.RB().ii(DUST.getMaterialIngredient(Glowstone, 1), of(DUSTS_LAPIS_LAZ, 1)).io(new ItemStack(AdvancedCircuitParts, 2)).add("adv_circuit_parts",800,2);
        ...
        RecipeMaps.ASSEMBLER.RB().ii(of(BasicCircuitBoard, 1), of(GT4RBlocks.CABLE_COPPER.getBlockItem(PipeSize.VTINY), 3)).io(new ItemStack(BasicCircuit)).add("circuit_basic",800, 1);
