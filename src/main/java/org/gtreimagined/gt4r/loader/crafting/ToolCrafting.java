...
public class ToolCrafting {
    ...
    private static void loadBreakablePoweredRecipes(Consumer<FinishedRecipe> output, GTRecipeProvider provider){
        ...
        provider.addToolRecipe(ToolTypes.POWERED_TOOL_BUILDER.get(GTCoreTools.DRILL.getId() + "-lv"),output, GT4RRef.ID, GTCoreTools.DRILL.getId() + "_lv_" + "recipe", "antimatter_drills",
                resolveStack(drill_lv, Material.NULL, Aluminium, 0, 100000), of('B', PropertyIngredient.of(GTMaterialTypes.DRILL_BIT, "primary"), 'S', GTTools.SCREWDRIVER.getTag(), 'P', PropertyIngredient.builder("secondary").mats(Aluminium).types(PLATE).build(), 's', SCREW.getMaterialTag(Steel), 'b', PropertyIngredient.builder("battery").itemTags(BATTERIES_LV).build(), 'M', MotorLV), "sBS", "PMP", "PbP");
        provider.addToolRecipe(ToolTypes.POWERED_TOOL_BUILDER.get(GTCoreTools.DRILL.getId() + "-mv"),output, GT4RRef.ID, GTCoreTools.DRILL.getId() + "_mv_" + "recipe", "antimatter_drills",
                resolveStack(drill_mv, Material.NULL, StainlessSteel, 0, 200000), of('B', PropertyIngredient.of(GTMaterialTypes.DRILL_BIT, "primary"), 'S', GTTools.SCREWDRIVER.getTag(), 'P', PropertyIngredient.builder("secondary").mats(StainlessSteel).types(PLATE).build(), 's', SCREW.getMaterialTag(Steel), 'b', PropertyIngredient.builder("battery").itemTags(BATTERIES_MV).build(), 'M', MotorLV), "sBS", "PMP", "PbP");
        provider.addToolRecipe(ToolTypes.POWERED_TOOL_BUILDER.get(GTCoreTools.DRILL.getId() + "-hv"),output, GT4RRef.ID, GTCoreTools.DRILL.getId() + "_hv_" + "recipe", "antimatter_drills",
                resolveStack(drill_hv, Material.NULL, Titanium, 0, 800000), of('B', PropertyIngredient.of(GTMaterialTypes.DRILL_BIT, "primary"), 'S', GTTools.SCREWDRIVER.getTag(), 'P', PropertyIngredient.builder("secondary").mats(Titanium, TungstenSteel).types(PLATE).build(), 's', SCREW.getMaterialTag(Steel), 'b', PropertyIngredient.builder("battery").itemTags(BATTERIES_HV).build(), 'M', MotorLV), "sBS", "PMP", "PbP");
        ...
        provider.addToolRecipe(ToolTypes.POWERED_TOOL_BUILDER.get(GTCoreTools.CHAINSAW.getId() + "-lv"),output, GT4RRef.ID, GTCoreTools.CHAINSAW.getId() + "_lv_" + "recipe", "antimatter_chainsaws",
                resolveStack(chainsaw_lv, Material.NULL, Aluminium, 0, 100000), of('B', PropertyIngredient.of(GTMaterialTypes.CHAINSAW_BIT, "primary"), 'S', GTTools.SCREWDRIVER.getTag(), 'P', PropertyIngredient.builder("secondary").mats(Aluminium).types(PLATE).build(), 's', SCREW.getMaterialTag(Steel), 'b', PropertyIngredient.builder("battery").itemTags(BATTERIES_LV).build(), 'M', MotorLV), "sBS", "PMP", "PbP");
        provider.addToolRecipe(ToolTypes.POWERED_TOOL_BUILDER.get(GTCoreTools.CHAINSAW.getId() + "-mv"),output, GT4RRef.ID, GTCoreTools.CHAINSAW.getId() + "_mv_" + "recipe", "antimatter_chainsaws",
                resolveStack(chainsaw_mv, Material.NULL, StainlessSteel, 0, 200000), of('B', PropertyIngredient.of(GTMaterialTypes.CHAINSAW_BIT, "primary"), 'S', GTTools.SCREWDRIVER.getTag(), 'P', PropertyIngredient.builder("secondary").mats(StainlessSteel).types(PLATE).build(), 's', SCREW.getMaterialTag(Steel), 'b', PropertyIngredient.builder("battery").itemTags(BATTERIES_MV).build(), 'M', MotorLV), "sBS", "PMP", "PbP");
        provider.addToolRecipe(ToolTypes.POWERED_TOOL_BUILDER.get(GTCoreTools.CHAINSAW.getId() + "-hv"),output, GT4RRef.ID, GTCoreTools.CHAINSAW.getId() + "_hv_" + "recipe", "antimatter_chainsaws",
                resolveStack(chainsaw_hv, Material.NULL, Titanium, 0, 800000), of('B', PropertyIngredient.of(GTMaterialTypes.CHAINSAW_BIT, "primary"), 'S', GTTools.SCREWDRIVER.getTag(), 'P', PropertyIngredient.builder("secondary").mats(Titanium, TungstenSteel).types(PLATE).build(), 's', SCREW.getMaterialTag(Steel), 'b', PropertyIngredient.builder("battery").itemTags(BATTERIES_HV).build(), 'M', MotorLV), "sBS", "PMP", "PbP");
        ...
        provider.addToolRecipe(ToolTypes.POWERED_TOOL_BUILDER.get(GTCoreTools.ELECTRIC_WRENCH.getId() + "-lv"),output, GT4RRef.ID, GTCoreTools.ELECTRIC_WRENCH.getId() + "_lv_" + "recipe", "antimatter_electric_wrenches",
                resolveStack(electric_wrench_lv, Material.NULL, Aluminium, 0, 100000), of('B', PropertyIngredient.of(GTMaterialTypes.WRENCH_BIT, "primary"), 'S', GTTools.SCREWDRIVER.getTag(), 'P', PropertyIngredient.builder("secondary").mats(Aluminium).types(PLATE).build(), 's', SCREW.getMaterialTag(Steel), 'b', PropertyIngredient.builder("battery").itemTags(BATTERIES_LV).build(), 'M', MotorLV), "sBS", "PMP", "PbP");
        provider.addToolRecipe(ToolTypes.POWERED_TOOL_BUILDER.get(GTCoreTools.ELECTRIC_WRENCH.getId() + "-mv"),output, GT4RRef.ID, GTCoreTools.ELECTRIC_WRENCH.getId() + "_mv_" + "recipe", "antimatter_electric_wrenches",
                resolveStack(electric_wrench_mv, Material.NULL, StainlessSteel, 0, 200000), of('B', PropertyIngredient.of(GTMaterialTypes.WRENCH_BIT, "primary"), 'S', GTTools.SCREWDRIVER.getTag(), 'P', PropertyIngredient.builder("secondary").mats(StainlessSteel).types(PLATE).build(), 's', SCREW.getMaterialTag(Steel), 'b', PropertyIngredient.builder("battery").itemTags(BATTERIES_MV).build(), 'M', MotorLV), "sBS", "PMP", "PbP");
        provider.addToolRecipe(ToolTypes.POWERED_TOOL_BUILDER.get(GTCoreTools.ELECTRIC_WRENCH.getId() + "-hv"),output, GT4RRef.ID, GTCoreTools.ELECTRIC_WRENCH.getId() + "_hv_" + "recipe", "antimatter_electric_wrenches",
                resolveStack(electric_wrench_hv, Material.NULL, Titanium, 0, 800000), of('B', PropertyIngredient.of(GTMaterialTypes.WRENCH_BIT, "primary"), 'S', GTTools.SCREWDRIVER.getTag(), 'P', PropertyIngredient.builder("secondary").mats(Titanium, TungstenSteel).types(PLATE).build(), 's', SCREW.getMaterialTag(Steel), 'b', PropertyIngredient.builder("battery").itemTags(BATTERIES_HV).build(), 'M', MotorLV), "sBS", "PMP", "PbP");
