...
public class WorldGenLoader {
    ...
    private static void initVanillaOres(GTWorldGenEvent event){
        ...
        if (GTLibConfig.VANILLA_ORE_GEN.get()){
            ...
            event.vanillaOre(new VanillaVeinBuilder(id("diamond")).withMaterial(Diamond).atHeight(-144, 16).withWeight(7).withSize(4).withSecondaryMaterial(Diamond, 0.03f).withSecondaryType(GTMaterialTypes.SMALL_ORE).withDiscardOnExposureChance(0.5f).setHasTriangleHeight(true).inDimension(Level.OVERWORLD).buildMaterial());
            event.vanillaOre(new VanillaVeinBuilder(id("diamond_large")).withMaterial(Diamond).atHeight(-144, 16).withProbability(9).withSecondaryMaterial(Diamond, 0.03f).withSecondaryType(GTMaterialTypes.SMALL_ORE).withSize(12).withDiscardOnExposureChance(0.7f).setHasTriangleHeight(true).inDimension(Level.OVERWORLD).buildMaterial());
            event.vanillaOre(new VanillaVeinBuilder(id("diamond_buried")).withMaterial(Diamond).atHeight(-144, 16).withWeight(4).withSecondaryMaterial(Diamond, 0.03f).withSecondaryType(GTMaterialTypes.SMALL_ORE).withSize(8).withDiscardOnExposureChance(1.0f).setHasTriangleHeight(true).inDimension(Level.OVERWORLD).buildMaterial());
