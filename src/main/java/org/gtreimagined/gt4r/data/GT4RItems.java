...
import org.gtreimagined.gt4r.items.ItemSteelUpgrade;
...
public class GT4RItems {
    ...
    public static ItemBasic<?> SteelUpgrade = new ItemSteelUpgrade().tip("Can be used to upgrade bronze steam machines to steel steam machines");
    ...
    public static ItemBasic<?> LithiumBattery = new ItemMultiTextureBattery(GT4RRef.ID, "lithium_battery", Tier.MV, 100_000, true);
