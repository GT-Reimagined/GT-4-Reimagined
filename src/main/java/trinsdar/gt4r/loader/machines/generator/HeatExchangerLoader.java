...
public class HeatExchangerLoader {
    public static void init(){
        ...
        THERMAL_BOILER_FUELS.RB().fi(new FluidStack(Fluids.WATER, 5), new FluidStack(Fluids.LAVA, 83)).fo(Steam.getGas(800)).io(new ItemStack(Items.OBSIDIAN), NUGGET.get(Tin, 1), NUGGET.get(Copper, 1), NUGGET.get(Electrum, 1)).chances(90, 5, 4, 1).add(1);
    }
}
