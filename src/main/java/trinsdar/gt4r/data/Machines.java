...
public class Machines {
    ...
    public static MaterialMachine IRON_CABINET = new MaterialMachine(Ref.ID, "iron_cabinet", Materials.Iron).addFlags(ITEM, GUI, COVERABLE).overlayTexture(Textures.CABINET_OVERLAY_HANDLER).baseTexture(Textures.CABINET_HANDLER).setTiers(LV).setTile(m -> () -> new TileEntityCabinet(m, 222));
    ...
    public static MaterialMachine GOLD_CABINET = new MaterialMachine(Ref.ID, "gold_cabinet", Materials.Gold).addFlags(ITEM, GUI, COVERABLE).overlayTexture(Textures.CABINET_OVERLAY_HANDLER).baseTexture(Textures.CABINET_HANDLER).setTiers(LV).setTile(m -> () -> new TileEntityCabinet(m, 240));
