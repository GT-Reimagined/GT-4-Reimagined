...
public class Machines {
    ...
    public static MaterialMachine NETHERITE_DRUM = new MaterialMachine(Ref.ID, "netherite_drum", Materials.Netherite).setTiers(LV).baseTexture(Textures.DRUM_HANDLER).overlayTexture(Textures.DRUM_OVERLAY_HANDLER).addFlags(COVERABLE, FLUID).setTile(m -> () -> new TileEntityDrum(m)).allowFrontIO();
