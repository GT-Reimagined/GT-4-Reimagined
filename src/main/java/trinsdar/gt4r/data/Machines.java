...
public class Machines {
    ...
    public static BasicMachine MACERATOR = new BasicMachine(Ref.ID, "macerator", MACERATING, GUI, ITEM, LV, MV, Textures.TIER_SPECIFIC_OVERLAY_HANDLER);
    ...
    public static MaterialMachine WROUGHT_IRON_CABINET = new MaterialMachine(Ref.ID, "wrought_iron_cabinet", Materials.WroughtIron, LV, Textures.CABINET_HANDLER, Textures.CABINET_OVERLAY_HANDLER, ITEM, GUI, COVERABLE);
    public static MaterialMachine BRASS_CABINET = new MaterialMachine(Ref.ID, "brass_cabinet", Materials.Brass, LV, Textures.CABINET_HANDLER, Textures.CABINET_OVERLAY_HANDLER, ITEM, GUI, COVERABLE);
    public static MaterialMachine CUPRONICKEL_CABINET = new MaterialMachine(Ref.ID, "cupronickel_cabinet", Materials.Cupronickel, LV, Textures.CABINET_HANDLER, Textures.CABINET_OVERLAY_HANDLER, ITEM, GUI, COVERABLE);
    public static MaterialMachine ELECTRUM_CABINET = new MaterialMachine(Ref.ID, "electrum_cabinet", Materials.Electrum, LV, Textures.CABINET_HANDLER, Textures.CABINET_OVERLAY_HANDLER, ITEM, GUI, COVERABLE);
    public static MaterialMachine GOLD_CABINET = new MaterialMachine(Ref.ID, "gold_cabinet", Materials.Gold, LV, Textures.CABINET_HANDLER, Textures.CABINET_OVERLAY_HANDLER, ITEM, GUI, COVERABLE);
    public static MaterialMachine SILVER_CABINET = new MaterialMachine(Ref.ID, "silver_cabinet", Materials.Silver, LV, Textures.CABINET_HANDLER, Textures.CABINET_OVERLAY_HANDLER, ITEM, GUI, COVERABLE);
    public static MaterialMachine MAGNALIUM_CABINET = new MaterialMachine(Ref.ID, "magnalium_cabinet", Materials.Magnalium, LV, Textures.CABINET_HANDLER, Textures.CABINET_OVERLAY_HANDLER, ITEM, GUI, COVERABLE);
    public static MaterialMachine PLATINUM_CABINET = new MaterialMachine(Ref.ID, "platinum_cabinet", Materials.Platinum, LV, Textures.CABINET_HANDLER, Textures.CABINET_OVERLAY_HANDLER, ITEM, GUI, COVERABLE);
    public static MaterialMachine OSMIUM_CABINET = new MaterialMachine(Ref.ID, "osmium_cabinet", Materials.Osmium, LV, Textures.CABINET_HANDLER, Textures.CABINET_OVERLAY_HANDLER, ITEM, GUI, COVERABLE);
    ...
    public static MaterialMachine IRON_LOCKER = new MaterialMachine(Ref.ID, "iron_locker", Materials.Iron, LV, Textures.LOCKER_HANDLER, Textures.LOCKER_OVERLAY_HANDLER, ITEM, GUI).setTile(m -> () -> new TileEntityLocker(m));
    public static MaterialMachine ALUMINIUM_LOCKER = new MaterialMachine(Ref.ID, "aluminium_locker", Materials.Aluminium, LV, Textures.LOCKER_HANDLER, Textures.LOCKER_OVERLAY_HANDLER, ITEM, GUI).setTile(m -> () -> new TileEntityLocker(m));
    public static MaterialMachine IRON_CHARGING_LOCKER = new MaterialMachine(Ref.ID, "iron_charging_locker", Materials.Iron, HV, Textures.LOCKER_HANDLER, Textures.CHARGING_LOCKER_OVERLAY_HANDLER, ITEM, GUI, ENERGY).setTile(m -> () -> new TileEntityLocker(m));
    public static MaterialMachine ALUMINIUM_CHARGING_LOCKER = new MaterialMachine(Ref.ID, "aluminium_charging_locker", Materials.Aluminium, HV, Textures.LOCKER_HANDLER, Textures.CHARGING_LOCKER_OVERLAY_HANDLER, ITEM, GUI, ENERGY).setTile(m -> () -> new TileEntityLocker(m));
    ...
    public static BasicMachine TRANSFORMER = new BasicMachine(Ref.ID, "transformer", ENERGY, CONFIGURABLE, LV, MV, HV, IV, EV, LUV, ZPM, UV, Textures.TIER_SPECIFIC_OVERLAY_HANDLER).setTile(m -> () -> new TileEntityTransformer(m, 1)).covers((ICover[]) null).setAllowVerticalFacing(true);
