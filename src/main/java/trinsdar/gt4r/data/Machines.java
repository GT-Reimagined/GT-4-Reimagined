...
public class Machines {
    ...
    public static BasicMachine CUTTER = new BasicMachine(Ref.ID, "plate_cutter", CUTTING, GUI, ITEM, LV, Textures.MACHINE_BASE);
    ...
    public static HatchMachine HATCH_ITEM_I = new HatchMachine(Ref.ID, "hatch_item_input", GUI, ITEM,COVERINPUT, LV, Textures.MACHINE_BASE).setTiers(LV);
    public static HatchMachine HATCH_ITEM_O = new HatchMachine(Ref.ID, "hatch_item_output", GUI, ITEM, COVEROUTPUT, LV, Textures.MACHINE_BASE).setTiers(LV);
    public static HatchMachine HATCH_FLUID_I = new HatchMachine(Ref.ID, "hatch_fluid_input", GUI, FLUID, COVERINPUT, CELL, LV, Textures.MACHINE_BASE).setTiers(LV);
    public static HatchMachine HATCH_FLUID_O = new HatchMachine(Ref.ID, "hatch_fluid_output", GUI, FLUID, COVEROUTPUT, CELL, LV, Textures.MACHINE_BASE).setTiers(LV);
    public static HatchMachine HATCH_MUFFLER = new HatchMachine(Ref.ID, "hatch_muffler", GUI, ITEM,COVERMUFFLER, LV, Textures.MACHINE_BASE).setTiers(LV);
    ...
    public static HatchMachine FUSION_MATERIAL_INJECTOR = new HatchMachine(Ref.ID, "fusion_material_injector", GUI, ITEM, LV, Textures.MACHINE_BASE).setTiers(LV);
    public static HatchMachine FUSION_MATERIAL_EXTRACTOR = new HatchMachine(Ref.ID, "fusion_material_extractor", GUI, ITEM, LV, Textures.MACHINE_BASE).setTiers(LV);
