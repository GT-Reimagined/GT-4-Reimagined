...
public class Machines {
    ...
    public static MaterialMachine IRON_CHEST = new ChestMachine(Ref.ID, "iron_chest",Iron).addFlags(ITEM, GUI).overlayTexture(Textures.CHEST_OVERLAY_HANDLER).baseTexture(Textures.CHEST_HANDLER).custom(Textures.CHEST_MODELS).setTiers(LV).setTile(m -> () -> new TileEntityChest(m, 222));
    public static MaterialMachine ALUMINIUM_CHEST = new ChestMachine(Ref.ID, "aluminium_chest", Materials.Aluminium).addFlags(ITEM, GUI).overlayTexture(Textures.CHEST_OVERLAY_HANDLER).baseTexture(Textures.CHEST_HANDLER).custom(Textures.CHEST_MODELS).setTiers(LV).setTile(m -> () -> new TileEntityChest(m, 222));
    public static MaterialMachine WROUGHT_IRON_CHEST = new ChestMachine(Ref.ID, "wrought_iron_chest", Materials.WroughtIron).addFlags(ITEM, GUI).overlayTexture(Textures.CHEST_OVERLAY_HANDLER).baseTexture(Textures.CHEST_HANDLER).custom(Textures.CHEST_MODELS).setTiers(LV).setTile(m -> () -> new TileEntityChest(m, 222));
    public static MaterialMachine BRASS_CHEST = new ChestMachine(Ref.ID, "brass_chest", Materials.Brass).addFlags(ITEM, GUI).overlayTexture(Textures.CHEST_OVERLAY_HANDLER).baseTexture(Textures.CHEST_HANDLER).custom(Textures.CHEST_MODELS).setTiers(LV).setTile(m -> () -> new TileEntityChest(m, 222));
    public static MaterialMachine CUPRONICKEL_CHEST = new ChestMachine(Ref.ID, "cupronickel_chest", Materials.Cupronickel).addFlags(ITEM, GUI).overlayTexture(Textures.CHEST_OVERLAY_HANDLER).baseTexture(Textures.CHEST_HANDLER).custom(Textures.CHEST_MODELS).setTiers(LV).setTile(m -> () -> new TileEntityChest(m, 222));
    public static MaterialMachine ELECTRUM_CHEST = new ChestMachine(Ref.ID, "electrum_chest", Materials.Electrum).addFlags(ITEM, GUI).overlayTexture(Textures.CHEST_OVERLAY_HANDLER).baseTexture(Textures.CHEST_HANDLER).custom(Textures.CHEST_MODELS).setTiers(LV).setTile(m -> () -> new TileEntityChest(m, 240));
    public static MaterialMachine GOLD_CHEST = new ChestMachine(Ref.ID, "gold_chest", Gold).addFlags(ITEM, GUI).overlayTexture(Textures.CHEST_OVERLAY_HANDLER).baseTexture(Textures.CHEST_HANDLER).custom(Textures.CHEST_MODELS).setTiers(LV).setTile(m -> () -> new TileEntityChest(m, 240));
    public static MaterialMachine SILVER_CHEST = new ChestMachine(Ref.ID, "silver_chest", Materials.Silver).addFlags(ITEM, GUI).overlayTexture(Textures.CHEST_OVERLAY_HANDLER).baseTexture(Textures.CHEST_HANDLER).custom(Textures.CHEST_MODELS).setTiers(LV).setTile(m -> () -> new TileEntityChest(m, 240));
    public static MaterialMachine MAGNALIUM_CHEST = new ChestMachine(Ref.ID, "magnalium_chest", Materials.Magnalium).addFlags(ITEM, GUI).overlayTexture(Textures.CHEST_OVERLAY_HANDLER).baseTexture(Textures.CHEST_HANDLER).custom(Textures.CHEST_MODELS).setTiers(LV).setTile(m -> () -> new TileEntityChest(m, 240));
    public static MaterialMachine PLATINUM_CHEST = new ChestMachine(Ref.ID, "platinum_chest", Materials.Platinum).addFlags(ITEM, GUI).overlayTexture(Textures.CHEST_OVERLAY_HANDLER).baseTexture(Textures.CHEST_HANDLER).custom(Textures.CHEST_MODELS).setTiers(LV).setTile(m -> () -> new TileEntityChest(m, 258));
    public static MaterialMachine OSMIUM_CHEST = new ChestMachine(Ref.ID, "osmium_chest", Materials.Osmium).addFlags(ITEM, GUI).overlayTexture(Textures.CHEST_OVERLAY_HANDLER).baseTexture(Textures.CHEST_HANDLER).custom(Textures.CHEST_MODELS).setTiers(LV).setTile(m -> () -> new TileEntityChest(m, 276));
