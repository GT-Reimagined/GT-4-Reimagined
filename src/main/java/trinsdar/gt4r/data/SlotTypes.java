...
public class SlotTypes {
    ...
    public static SlotType DISPLAY = new SlotType("display", (t, i, d) -> Optional.of(new SlotDisplay(t.itemHandler.map(MachineItemHandler::getInputGuiHandler).orElse(null), i, d.getX(), d.getY())));
}
