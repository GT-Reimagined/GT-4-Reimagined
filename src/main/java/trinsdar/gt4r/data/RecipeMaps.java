...
public class RecipeMaps {
    ...
    public static RecipeMap DIESEL_FUELS = new RecipeMap<>("diesel_fuels", new RecipeBuilder(), InfoRenderers.FUEL_RENDERER);
    public static RecipeMap LAVA_FUELS = new RecipeMap<>("lava_fuels", new RecipeBuilder(), InfoRenderers.FUEL_RENDERER);
    public static RecipeMap SEMIFLUID_FUELS = new RecipeMap<>("semifluid_fuels", new RecipeBuilder(), InfoRenderers.FUEL_RENDERER);
