...
import trinsdar.gt4r.loader.machines.MaceratorAutoLoader;
import trinsdar.gt4r.loader.machines.MaceratorManualLoader;
...
public class AntimatterEvents {
    ...
    public static void registerRecipeLoaders(AntimatterLoaderEvent event) {
        ...
        loader.accept("macerating_automatic", MaceratorAutoLoader::init);
        loader.accept("macerating_manual", MaceratorManualLoader::init);
    ...
    public static void onProviders(AntimatterProvidersEvent event){
        ...
        event.addProvider(Ref.ID, g -> new AntimatterFluidTagProvider(Ref.ID, Ref.NAME.concat(" Fluid Tags"), false, g, new ExistingFileHelperOverride()));
