...
public class ScreenButtonCover<T extends ContainerCover> extends ScreenCover<T> {
    public ScreenButtonCover(T container, PlayerInventory inv, ITextComponent name) {
