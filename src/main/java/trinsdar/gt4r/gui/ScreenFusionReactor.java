...
public class ScreenFusionReactor<T extends ContainerMultiMachine> extends ScreenMultiMachine<T> {
    ResourceLocation middle = new ResourceLocation(Ref.ID, "textures/gui/fusion_computer_middle_overlay.png");
    ResourceLocation top_bottom = new ResourceLocation(Ref.ID, "textures/gui/fusion_computer_top_bottom_overlay.png");
