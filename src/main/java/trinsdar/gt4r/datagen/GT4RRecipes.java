        ...
        mainMats.forEach(main -> {
            ...
            if (main.getToolTypes().contains(CHAINSAW)){
                ...
                addStackRecipe(consumer, Ref.ID, CHAINSAW.getId() + "_mv_" + main.getId() + "_lithium", "antimatter_mv_chainsaws",
                        "has_material_" + main.getId(), this.hasSafeItem(CHAINSAWBIT.getMaterialTag(main)), chainsaw_mv.resolveStack(main, Titanium, 0, 400000), of2('B', CHAINSAWBIT.getMaterialTag(main), 'S', SCREWDRIVER.getTag(), 'P', PLATE.getMaterialTag(Titanium), 's', SCREW.getMaterialTag(Titanium), 'b', BatteryMediumLithium, 'M', MotorMV), "sBS", "PbP", "PbP", "PMP");
            ...
            if (main.getToolTypes().contains(ELECTRIC_WRENCH)){
                ...
                addStackRecipe(consumer, Ref.ID, ELECTRIC_WRENCH.getId() + "_mv_" + main.getId() + "_lithium", "antimatter_mv_electric_wrenches",
                        "has_material_" + main.getId(), this.hasSafeItem(WRENCHBIT.getMaterialTag(main)), wrench_mv.resolveStack(main, Titanium, 0, 400000), of2('B', WRENCHBIT.getMaterialTag(main), 'S', SCREWDRIVER.getTag(), 'P', PLATE.getMaterialTag(Titanium), 's', SCREW.getMaterialTag(Titanium), 'b', BatteryMediumLithium, 'M', MotorMV), "sBS", "PbP", "PbP", "PMP");
            ...
            if (main.getToolTypes().contains(BUZZSAW)){
                ...
                addStackRecipe(consumer, Ref.ID, BUZZSAW.getId() + "_mv_" + main.getId() + "_lithium", "antimatter_mv_buzzsaws",
                        "has_material_" + main.getId(), this.hasSafeItem(BUZZSAW_BLADE.getMaterialTag(main)), buzzsaw_mv.resolveStack(main, Titanium, 0, 400000), of2('B', BUZZSAW_BLADE.getMaterialTag(main), 'S', SCREWDRIVER.getTag(), 'P', PLATE.getMaterialTag(Titanium), 's', SCREW.getMaterialTag(Titanium), 'b', BatteryMediumLithium, 'M', MotorMV), "sBS", "PbP", "PbP", "PMP");
